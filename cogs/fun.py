...
class Fun(commands.Cog):
    ...
    async def renai(self, ctx):
        ...
        lyrics = ["Se no!", "Demo sonnan ja dame", "Mou sonnan ja hora", "Kokoro wa shinka suru yo", "Motto motto", "", "Kotoba ni sureba kiechau kankei nara", "Kotoba o keseba ii ya tte",
        "Omotteta osoreteta",
