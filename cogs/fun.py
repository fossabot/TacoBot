...
class Fun(commands.Cog):
    ...
    async def renai(self, ctx):
        ...
        lyrics = [
            ...
            "Egao ni naru", "", "Kami-sama arigatou", "Unmei no itazura demo",
            "Meguriaeta koto ga", "Shiawase na no", "", "Demo sonnan ja dame",
            "Mou sonnan ja hora", "Kokoro wa shinka suru yo", "Motto motto",
            "Sou sonnan ja ya da", "Nee sonnan ja mada", "Zutto zutto",
            "Watashi no koto mitete ne", "", "Watashi no naka no anata hodo",
        ...
        message = await ctx.send("**Renai Circulation**")
